...
export const Route = createFileRoute("/ebooks/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Spiritual eBooks in EPUB format — delivered instantly to your account." },
      { property: "og:title", content: "eBooks — Dada Vaswani's Books" },
      { property: "og:description", content: "Spiritual eBooks in EPUB format — delivered instantly." },
